    ...
    <article class="post">
        ...
        <div class="post-content">
            <header class="entry-header text-center text-uppercase">
                ...
                <h6>
                    ...
                    foreach ($cats as $ind => $cat) {
                        $cat = explode("=", $cat)
                        ?>
                        <a href="?p=posts&category=<? strip_tags($cat[0]) ?>">
                            <?= strip_tags($cat[1]) ?>
                            <?php
                            if ($ind != count($cats) - 1) {
                                echo ",";
                ...
                <h1 class="entry-title"><a
                            href="?p=post&url<?= strip_tags($data["url"]) ?>"><?= htmlspecialchars($data["title"]) ?></a>
                </h1>
            ...
            <div class="social-share">
							<span
                                    class="social-share-title pull-left text-capitalize">By <?= $data["author"] ?> On <?= $data["date"] ?>
                            </span>
